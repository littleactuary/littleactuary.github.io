---
layout: post
title: "Short Term Actuarial Mathematics (STAM)"
modified:
categories: blog
...
A good case application of spliced distributions is where the tail's behaviour is very different to small losses'.
