...
You can download my CV in PDF format here ([**french**]({{ site.url }}/images/CV_Duc_Hien_VU_fr.pdf){:target="_blank"}, [**english**]({{ site.url }}/images/CV_Duc_Hien_VU_en.pdf){:target="_blank"}, [**vietnamese**]({{ site.url }}/images/CV_Duc_Hien_VU_vi.pdf){:target="_blank"}). 
