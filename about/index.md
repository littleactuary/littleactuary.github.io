...
If you want to learn Jekyll, I recommend you to start with [**Jekyll site**](http://jekyllrb.com) with a complete documentation. Some intro to Jekyll video can be found on Youtube, like [**this one**](https://www.youtube.com/watch?v=O7NBEFmA7yA). You also need to know about [**GitHub pages**](https://pages.github.com). With Jekyll, you can build you site from scratch, or simply use a ready-to-use template (as I did). Here's some [**Jekyll themes**](http://jekyllthemes.org). That's all for now.'         
